...
/**
 * Command implementation for {@code resetFlow} method of {@link me.aartikov.alligator.AndroidNavigator}.
 */
public class ResetFlowCommand implements Command {
    private Screen mScreen;
    @Nullable
    private AnimationData mAnimationData;

    public ResetFlowCommand(@NonNull Screen screen, @Nullable AnimationData animationData) {
        mScreen = screen;
    ...
    public boolean execute(@NonNull NavigationContext navigationContext,
        ...
        return flowManager.reset(mScreen, navigationContext.getFlowTransitionListener(), mAnimationData);
    }
}
