...
public class FragmentScreenSwitcher implements ScreenSwitcher {
    ...
    private final NavigationFactory mNavigationFactory;
    private final ScreenResolver mScreenResolver;
    private final AnimationProvider mAnimationProvider;
    ...
    private Fragment getOrCreateFragment(Screen screen, FragmentDestination destination) throws NavigationException {
        ...
        if (fragment == null) {
            ...
            try {
                ...
                throw new ScreenRegistrationException(message != null ? message : "");
            }
